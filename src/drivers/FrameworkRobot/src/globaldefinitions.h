...
//--------------------------------------------------------------------------*
const int MAXNBBOTS = 100;                    // Max nbr of drivers per robot
...
//==========================================================================*
// Forewarding for classes and pointers to classes
//--------------------------------------------------------------------------*
class TAbstractDriver;
typedef TAbstractDriver* PAbstractDriver;

class TAbstractStrategy;
typedef TAbstractStrategy* PAbstractStrategy;

class TBaseDriver;
typedef TBaseDriver* PBaseDriver;

class TDriver;
typedef TDriver* PDriver;

class TBaseOpponent;
typedef TBaseOpponent* PBaseOpponent;

class TPit;
typedef TPit* PPit;

class TBaseStrategy;
typedef TBaseStrategy* PSimpleStrategy;
...
class TBaseTrack;
typedef TBaseTrack* PBaseTrack;
class TBaseSection;
typedef TBaseSection* PSection;
class TBaseLane;
typedef TBaseLane* PBaseLane;
//==========================================================================*
